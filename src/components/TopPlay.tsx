...
import { topPlayList } from '@/utils/data';
import { useEffect, useRef } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { Link } from 'react-router-dom';
// @ts-expect-error: Swiper FreeMode module might not have type declarations
import 'swiper/css';
// @ts-expect-error: Swiper FreeMode module might not have type declarations
        ...
        <div className="mt-4 flex flex-col">
          {topPlays?.map((song, i) => (
            <TopChartCard 
              ...
              i={i}
              isPlaying={isPlaying}
              activeSong={activeSong as ChartSongT | null}
